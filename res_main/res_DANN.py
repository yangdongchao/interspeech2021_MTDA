...
from models.DANN_model import DANN,DANN_R_RES
import os
...
opt.model = "DANN_R_RES"
# choose run on which device ["cuda", "cpu"]
opt.device = "cuda"

if opt in ['CIDA', 'PCIDA','DANN','DANN_R_RES']:
        opt.dropout = 0.2
else:
    opt.dropout = 0
...
dataset_train = ASC2020_DANN('/home/ydc/code2/CIDA-ASC/data/final_feature/final_train')
...
dataset_test = ASC2020_DANN('/home/ydc/code2/CIDA-ASC/data/final_feature/final_test')
