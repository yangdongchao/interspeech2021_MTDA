...
#print(sys.path)
from models.model import CIDA, PCIDA,CIDA_RES,CIDA_NO,CIDA_reg_no
import os
...
opt.model = "CIDA_reg_no"
# choose run on which device ["cuda", "cpu"]
opt.device = "cuda"

if opt in ['CIDA', 'PCIDA','CIDA_NO','CIDA_reg_no']:
        opt.dropout = 0.2
else:
    opt.dropout = 0
...
# experiment folder
opt.exp = '20_CIDA_reg_NO' + opt.model
opt.outf = './' + opt.exp
