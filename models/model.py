...
class CIDA(BaseModel):
    def __init__(self, opt):
        ...
        self.lr_scheduler_D = lr_scheduler.ExponentialLR(optimizer=self.optimizer_D, gamma=0.5 ** (1 / 50))
        self.lr_schedulers = [self.lr_scheduler_G, self.lr_scheduler_D]
        self.train_log = opt.outf + '/train_gan2CIDA_new_data_dict_without_index.log'
        self.model_path = opt.outf + '/model_gan2CIDA_new_data_dict_without_index.pth'
        self.lambda_gan = opt.lambda_gan
        self.loss_names = ['D', 'E_gan', 'E_pred']
    ...
    def optimize_parameters(self):
        ...
        self.backward_G()
        self.optimizer_G.step()
class CIDA2019(BaseModel):
    def __init__(self, opt):
        super(CIDA2019, self).__init__(opt)
        ...
        self.lr_scheduler_D = lr_scheduler.ExponentialLR(optimizer=self.optimizer_D, gamma=0.5 ** (1 / 50))
        self.lr_schedulers = [self.lr_scheduler_G, self.lr_scheduler_D]
        self.train_log = opt.outf + '/CIDA_2019_model_version.log'
        self.model_path = opt.outf + '/CIDA_2019_model_version.pth'
        self.lambda_gan = opt.lambda_gan
        self.loss_names = ['D', 'E_gan', 'E_pred']
