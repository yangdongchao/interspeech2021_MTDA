...
#print(sys.path)
from models.GAN_ASC import ADDA,Adaptation,Wadaptation,GAN
import os
import torch
...
opt.device_to_num = 1
opt.div = 10
opt.exp = 'Wadapt_train' + opt.model
...
source_model.load_state_dict(torch.load("/home/ydc/code2/CIDA-ASC/Main/dump/gan20_last_versiongan/_no_adapt_gan20_train.pth"))

target_model  = model_pool['gan'](opt)
target_model = target_model.to(opt.device)
target_model.load_state_dict(torch.load("/home/ydc/code2/CIDA-ASC/Main/dump/gan20_last_versiongan/_no_adapt_gan20_train.pth"))
