...
from models.DANN_model import DANN,DANN2019,DANN2019_R,DANN2019NO

import os
from torch.utils.data import DataLoader
import torch
from data.dataset import ASC2020,MyDataset,ASC2020_pre,ASC2020_DANN,ASC2020_bc
def print_args(opt):
...
opt.model = "DANN2019_R"
# choose run on which device ["cuda", "cpu"]
opt.device = "cuda"

if opt in ['CIDA', 'PCIDA','DANN','DANN2019']:
        opt.dropout = 0.2
else:
    opt.dropout = 0
...
# experiment folder
opt.exp = '20_true_DANN2019_' + opt.model
...
model_pool = {
    ...
    'PCIDA': PCIDA,
    'DANN2019': DANN2019,
    'DANN2019_R': DANN2019_R,
    'DANN2019NO': DANN2019NO
    #'ADDA': ADDA,
    #'DANN': DANN,
    # 'CUA': CUA,
}
