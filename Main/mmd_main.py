...
#print(sys.path)
from models.MMD_model import MMD,Adapt_MMD
import os
import torch
...
opt.device_to_num = 1
opt.div = 10
opt.exp = '20_MMD_adapt_train' + opt.model
...
# source_model = model_pool['ADDA'](opt)
# source_model = source_model.to(opt.device)
# print(source_model)
# source_model.load_state_dict(torch.load("/home/ydc/code2/CIDA-ASC/dump/pre_trainADDA/_pre_train.pth"))
...
source_net.load_state_dict(torch.load('/home/ydc/code2/CIDA-ASC/Main/dump/20_MMD_pre_trainMMD/MMD_pre_train.pth'))
# model.eval_mnist(train_dataloader)
# model.gen_result_table(train_dataloader)
# Find total parameters and trainable parameters
opt.netS = source_net
model = model_pool['Adapt_MMD'](opt)
